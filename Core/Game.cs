...
namespace Core
{
    public class Game
    {
        ...
        public Loaders.TextureLoader	TextureLoader	{ protected set; get; }
		public Loaders.ObjLoader		ObjLoader		{ protected set; get; }
		...
		public Game(string name, int width = 800, int height = 600)
		{
			...
			TextureLoader	= new Loaders.TextureLoader(this);
			ObjLoader		= new Loaders.ObjLoader();
		...
		protected void UpdateInternal()
		{
			...
			TotalTime = curTime;
            if (Simulation != null) Simulation.Timestep(deltaTime, ThreadDispatcher);
